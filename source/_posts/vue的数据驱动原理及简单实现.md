...
![definePropertypng](/gb/vue的数据驱动原理及简单实现/definePropertypng.png)
...
![intruduce](/gb/vue的数据驱动原理及简单实现/intruduce.png)
...
![Observer](/gb/vue的数据驱动原理及简单实现/Observer.png)
...
![progress](/gb/vue的数据驱动原理及简单实现/progress.png)
...
![imitate5](/gb/vue的数据驱动原理及简单实现/imitate5.png)
...
![imitate6](/gb/vue的数据驱动原理及简单实现/imitate6.png)
...
![imitate6_1](/gb/vue的数据驱动原理及简单实现/imitate6_1.png)
